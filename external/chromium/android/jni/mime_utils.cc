...
bool MimeUtils::GuessMimeTypeFromExtension(const std::string& extension,
  ...
  jclass tmp = env->FindClass("libcore/net/MimeUtils");
  m_clazz = static_cast<jclass>(env->NewGlobalRef(tmp));
  env->DeleteLocalRef(tmp);
  jmethodID method = env->GetStaticMethodID(m_clazz,
      "guessMimeTypeFromExtension", "(Ljava/lang/String;)Ljava/lang/String;");
  jobject jResult = env->CallStaticObjectMethod(m_clazz, method, jExtension);
...
bool MimeUtils::GuessExtensionFromMimeType(const std::string& mimeType,
  ...
  jmethodID method = env->GetStaticMethodID(m_clazz,
      "guessExtensionFromMimeType", "(Ljava/lang/String;)Ljava/lang/String;");
  jobject jResult = env->CallStaticObjectMethod(m_clazz, method, jMimeType);
